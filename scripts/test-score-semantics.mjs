...
assert.deepEqual(sellerScoreRows([malformedV2, legacy]), [legacy])
...
assert.equal(boundedMalformed.legacy_score, false)
assert.deepEqual(
  sortScoreRows([
